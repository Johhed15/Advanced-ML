...
The viterbi algorithm always chooses the next possible step with the highest probability and not the next step with the highest probability when you account for uncertainties, which the data have lots of as the gps is bad. 
