...
file RL Lab2 Colab.ipynb. The results provided in the file correspond to running the REIN-
FORCE algorithm for 5000 episodes with $\beta$ = 0 and $\gamma$ = 0.95. Each training episode uses a
...
The policy looks okay/decent, most of the time it finds the goal, but not every time. 
