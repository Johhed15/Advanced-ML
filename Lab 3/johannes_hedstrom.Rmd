...
Q-learning would have a problem to generalize to new data. But if we were to go through with the the algorithm we would have problems as we need to add the goals positions in the Q-table, making it significantly increase in size, and this would make the algorithm take time to converge and create storage space problems. 
