...
```{r fig.align='center', fig.width=4.5, fig.height=2.5, echo=FALSE, fig.cap='Posterior distribution with l=0.3'}
...
```{r fig.align='center', fig.width=5.5, fig.height=5, warning=FALSE, echo=FALSE}
